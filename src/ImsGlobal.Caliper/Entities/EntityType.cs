...
namespace ImsGlobal.Caliper.Entities
{
	...
	public class EntityType : IType, IJsonValue
	{
        ...
        public static readonly EntityType DateTimeQuestion = new EntityType("DateTimeQuestion");
        public static readonly EntityType DateTimeResponse = new EntityType("DateTimeResponse");
        ...
        public static readonly EntityType Feedback = new EntityType("Feedback");
        ...
        public static readonly EntityType LikertScale = new EntityType("LikertScale");
        ...
        public static readonly EntityType MultiSelectResponse = new EntityType("MultiselectResponse");
        public static readonly EntityType MultiSelectScale = new EntityType("MultiselectScale");
        public static readonly EntityType MultiSelectQuestion = new EntityType("MultiselectQuestion");
        public static readonly EntityType NumericScale = new EntityType("NumericScale");
        public static readonly EntityType Page = new EntityType("Page");
		public static readonly EntityType Person = new EntityType("Person");
        public static readonly EntityType OpenEndedResponse = new EntityType("OpenEndedResponse");
        public static readonly EntityType OpenEndedQuestion = new EntityType("OpenEndedQuestion");
        ...
        public static readonly EntityType Question = new EntityType("Question");
        public static readonly EntityType Questionnaire = new EntityType("Questionnaire");
        public static readonly EntityType QuestionnaireItem = new EntityType("QuestionnaireItem");
        public static readonly EntityType Rating = new EntityType("Rating");
        public static readonly EntityType RatingScaleResponse = new EntityType("RatingScaleResponse");
        public static readonly EntityType RatingScaleQuestion = new EntityType("RatingScaleQuestion");
        ...
        public static readonly EntityType Scale = new EntityType("Scale");
        ...
        public static readonly EntityType Survey = new EntityType("Survey");
        public static readonly EntityType SurveyInvitation = new EntityType("SurveyInvitation");
        public static readonly EntityType SystemIdentifier = new EntityType("SystemIdentifier");
        public static readonly EntityType Tag = new EntityType("TagAnnotation");
        public static readonly EntityType TextPositionSelector = new EntityType("TextPositionSelector");
