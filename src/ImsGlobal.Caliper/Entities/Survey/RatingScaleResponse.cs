...
namespace ImsGlobal.Caliper.Entities.Survey
{
	...
	public class RatingScaleResponse : Entity {

		public RatingScaleResponse(string id, ICaliperContext caliperContext = null)
			: base(id, caliperContext) {
			this.Type = EntityType.RatingScaleResponse;
		}
