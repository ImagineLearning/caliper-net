...
namespace ImsGlobal.Caliper.Entities.Survey
{
	...
	public class OpenEndedResponse : Entity {

		public OpenEndedResponse(string id, ICaliperContext caliperContext = null)
			: base(id, caliperContext) {
			this.Type = EntityType.OpenEndedResponse;
		}

		[JsonProperty("value", Order = 11 )]
